...
int main()
{
    ...
    // element_temp.descripteur_texte = descripteur_texte_finale("../DATA_FIL_ROUGE_DEV/Textes/28-Festival___Ososphère,_un_week-end.xml", 5, element_temp.descripteur_texte);
    //  MARCHE PAS
    //_____________
