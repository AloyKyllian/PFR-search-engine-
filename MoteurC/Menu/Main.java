...
public interface LireResultatRechercheLibrary extends Library {

    LireResultatRechercheLibrary INSTANCE = (LireResultatRechercheLibrary) Native.loadLibrary("LireResultatRecherche.so", RechercheMotLibrary.class);

    void rechercheMot(Pointer mot, Pointer chemin, Pointer tabResultat, int nb_mot, Pointer nbElTab, Pointer ptrErreur);

    int lire_chemin(tab_similaire *tabResultat, char *tabFileName[], int nbElement, Pointer type, int nombre_mot_cle, int similarite, Pointer erreur);

    char visualiser_fichier(char tabFileName[], int nbElement, Pointer type);

    void recup_CheminPour_Affichage(Pointer type, Pointer chemin);
...
public interface RechercheMotLibrary extends Library {
    ...
    RechercheMotLibrary INSTANCE = (RechercheMotLibrary) Native.loadLibrary("RechercheMot.so",RechercheMotLibrary.class);
    void rechercheMot(Pointer mot, Pointer chemin, Pointer tabResultat, int nb_mot, Pointer nbElTab, Pointer erreur);
