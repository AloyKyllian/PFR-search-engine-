...
public class ResultatImageController {
    ...
    private final ControlMenuImage controlMenuImage = new ControlMenuImage(controlLancerExecutable,controlLireResultat);
    private Stage stage;
    private final List<Color> allowedColors= Arrays.asList(Color.RED,Color.GREEN,Color.BLUE);
    @FXML
   ...
   /* @FXML
    ...
    void Valider(ActionEvent event) {
        ...
        listColor=controlMenuImage.rechercheCouleur(couleur);
        setBouttons(listColor);
    }
