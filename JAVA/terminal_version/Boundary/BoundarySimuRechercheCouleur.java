...
public class BoundarySimuRechercheCouleur {
	// attributs
	...
	public BoundarySimuRechercheCouleur() {
	...
	public void recherche(String couleur, int Pourcentage) {
		...
		if (couleur.equals("rouge")) {
			...
			ReadWriteFichier.ouvertureFichier(ListCheminFichier.cheminRGB + "16.jpg");
			...
			ReadWriteFichier.ouvertureFichier(ListCheminFichier.cheminRGB + "32.jpg");
			System.out.println("\nPenser a fermé la fenetre apres l'avoir consulter pour poursuivre votre activité\n");
			...
			ReadWriteFichier.ouvertureFichier(ListCheminFichier.cheminRGB + "07.jpg");
			System.out.println("\nPenser a fermé la fenetre apres l'avoir consulter pour poursuivre votre activité\n");
		}
		else
		{
			BoundaryErreur.afficherErreur(15);
		}
